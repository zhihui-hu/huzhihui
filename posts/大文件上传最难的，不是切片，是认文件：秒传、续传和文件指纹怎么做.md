...
image: /assets/imgs/nodejs-large-file-upload-instant-resume-s3-banner.png
...
![大文件上传最难的，不是切片，是认文件：秒传、续传和文件指纹怎么做头图](/assets/imgs/nodejs-large-file-upload-instant-resume-s3-banner.png)
